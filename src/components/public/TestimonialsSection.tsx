        ...
        <div>
          ...
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-2">
              {isFeatured && (
                <span className="text-[10px] uppercase tracking-wider text-[var(--accent)] font-semibold px-2 py-0.5 rounded-full bg-[var(--bg-surface)]">
                  Featured
                </span>
              )}
              <div className="w-8 h-8 rounded-full bg-[var(--bg-surface)] text-[var(--accent)] flex items-center justify-center">

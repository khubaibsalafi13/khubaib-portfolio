...
export const AllWork: React.FC<AllWorkProps> = ({ projects, categories }) => {
            ...
            {filteredProjects.map((project) => (
              ...
              >
                ...
                >
                  ...
                  {/* Year Tag */}
                  <span className="absolute top-3.5 right-3.5 px-2.5 py-1 rounded-full text-[11px] font-mono text-[var(--text-muted)] bg-[var(--bg-card)]/90 backdrop-blur-md border border-[var(--border-medium)] shadow-sm">
                    {project.year}
                  </span>
                </Link>
